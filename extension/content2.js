function a(h){
    const msgs = [
        "Are you watching something useful?",
        "Turn off the extension if its distracting you",
        "Just a reminder: it's been a long time",
        "Are you still there?",
        "You must be watching something useful",
        "Just so you know: time's flown by"
    ];
